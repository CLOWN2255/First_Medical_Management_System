...
QT_MOC_LITERAL(1, 7, 9), // "Rect_find"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 7), // "Thread*"
QT_MOC_LITERAL(4, 26, 10), // "Rect_Photo"
QT_MOC_LITERAL(5, 37, 11), // "onRect_find"
QT_MOC_LITERAL(6, 49, 12) // "onRect_Photo"

    },
    "Thread\0Rect_find\0\0Thread*\0Rect_Photo\0"
    "onRect_find\0onRect_Photo"
};
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Rect_find((*reinterpret_cast< Thread*(*)>(_a[1]))); break;
        case 1: _t->Rect_Photo((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->onRect_find(); break;
        case 3: _t->onRect_Photo((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Thread::*)(Thread * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::Rect_find)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Thread::Rect_Photo)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Thread::Rect_find(Thread * _t1)
{
...
// SIGNAL 1
void Thread::Rect_Photo(QByteArray _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
